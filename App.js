...
import { Text, View, Dimensions, StyleSheet, SafeAreaView, ScrollView, Image, TouchableWithoutFeedback, Animated } from 'react-native'
      ...
      <SafeAreaView style={style.container}>
        ...
        <ScrollView style={{ flex: 1 }}>
          ...
          {images.map((images, index) => (
            <TouchableWithoutFeedback key={index} onPress={() => this.openImage(index)}>

              <Animated.View style={{ height: SCREEN_HEIGHT - 150, width: SCREEN_WIDTH, padding: 15 }}>

                <Image ref={(image) => this.allImages[index] = image} source={images.src} style={{ flex: 1, width: null, height: null, resizeMode: "cover", borderRadius: 20 }} />
        ...
        <View pointerEvents={this.state.activeImage ? "auto" : "none"} style={StyleSheet.absoluteFill}>
          ...
          <View style={{ flex: 2, zIndex: 1001 }} ref={(view) => this.viewImage = view}>
            ...
            <Animated.View style={[{ flex: 1, zIndex: 1000, backgroundColor: 'white', padding: 20, paddingTop: 50 }, animatedContentStyle]}>
              ...
              <Text>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Numquam ipsam optio blanditiis aperiam beatae. Omnis eum fugiat ea quaerat expedita praesentium, aliquid facilis sit, eaque eveniet cumque sint laborum! Quia.
